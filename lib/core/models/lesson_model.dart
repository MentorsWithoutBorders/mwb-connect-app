...
class Lesson {
  ...
  Lesson({this.id, this.students, this.mentor, this.subfield, this.dateTime, this.daysSinceStart = 0, this.meetingUrl, this.endRecurrenceDateTime, this.isCanceled, this.reasonCanceled, this.shouldStop = false});
