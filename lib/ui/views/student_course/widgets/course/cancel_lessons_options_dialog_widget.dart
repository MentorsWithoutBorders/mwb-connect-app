...
import 'package:mwb_connect_app/ui/views/student_course/widgets/course/cancel_next_lesson_dialog_widget.dart';
import 'package:mwb_connect_app/utils/colors.dart';
import 'package:mwb_connect_app/ui/widgets/animated_dialog_widget.dart';

class CancelLessonsOptionsDialog extends StatefulWidget {
  const CancelLessonsOptionsDialog({Key? key, @required this.onCancelNextLesson, @required this.onCancelCourse, @required this.context})
    : super(key: key);
