...
class _CancelNextLessonOptionsDialogState extends State<CancelNextLessonOptionsDialog> {
  ...
  Widget _showTitle() {
    String title = 'Cancel recurring lesson';
    return Center(
      child: Text(
        title,
        ...
        children: <Widget>[
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: Text('Cancel only next lesson', style: const TextStyle(color: Colors.white))
            )
          ),
          SizedBox(
            width: double.infinity,
            child: ElevatedButton(
              ...
              child: Text('Cancel entire lesson recurrence', style: const TextStyle(color: Colors.white))
            )
          ),
          Padding(
            ...
            child: InkWell(
              child: Container(
                ...
                child: Center(                      
                  child: Text('Abort', style: const TextStyle(color: Colors.grey))
                )
              ),
              onTap: () {
