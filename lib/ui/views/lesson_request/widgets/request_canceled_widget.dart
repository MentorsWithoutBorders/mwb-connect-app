...
class RequestCanceled extends StatefulWidget {
  const RequestCanceled({Key key})
    : super(key: key); 

  @override
  State<StatefulWidget> createState() => _RequestCanceledState();
}

class _RequestCanceledState extends State<RequestCanceled> {

  Widget _showRequestCanceledCard() {
    return Padding(
  ...
  Widget _showText() {
    return Padding(
      ...
      child: Text(
        'lesson_request.request_canceled'.tr(),
  ...
  Widget build(BuildContext context) {
    return _showRequestCanceledCard();
  }
}